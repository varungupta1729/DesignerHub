...
export default function Editor({ tshirt, elStage, tshirtOnChange, setSelected, selected, setModal }) {
    ...
    return (
        <div onClick={() => setSelected(false)} className="w-full py-10 lg:py-0 min-h-0 lg:min-h-screen flex items-center justify-center bg-white">
            <div className="w-full px-5 lg:px-10">
                ...
                <div>
                    <button className="bg-black w-full rounded-sm text-white p-2 outline-none " onClick={() => setDLimage(true)}>Save Image</button>
                </div>
