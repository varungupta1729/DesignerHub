...
const Faq = () => {
  ...
  return (
    <div className={`${styles.section}  my-8`}>
      <h2 className="text-3xl font-bold text-[var(--text-dark)] mb-8">FAQ</h2>
      <div className="mx-auto space-y-4">
        {/* single Faq */}

        <div className="border-b border-[var(--text-dark)] pb-4">
          <button
          ...
          >
            ...
            {activeTab === 2 ? (
              <svg
                className="h-6 w-6 text-[var(--text-dark)]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
        ...
        <div className="border-b text-[var(--text-dark)] pb-4">
          <button
            className="flex items-center justify-between w-full"
            onClick={() => toggleTab(4)}
          >
